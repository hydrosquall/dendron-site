...
function initSearch() {
  ...
  request.open('GET', 'https://dendron.so/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', 'https://dendron.so/assets/css/just-the-docs-' + theme + '.css');
}

// Document ready

jtd.onReady(function(){
  // let homeOrId = window.location.pathname.split("/").slice(-1)[0].replace(/.html$/, '');
